...
public class ShippingInfoApis {
    ...
    @PostMapping("/add")
    private ResponseEntity<ResponseObject> addShippingInfo(@Valid @RequestBody ShippingInfoRequest shippingInfoRequest, @RequestParam("user_id") Integer userId) throws Exception {
